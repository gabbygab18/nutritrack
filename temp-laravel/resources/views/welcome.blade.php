...
<body>
    ...
    <div id="view-auth" class="auth-shell">
        <div class="auth-card">
            ...
            <p class="auth-note micro">This runs entirely in your browser — no server, no backend. Your account and logs
                are saved to this browser's local storage only.</p>
        </div>
    </div>
    ...
    <div id="lightboxOverlay" class="modal-overlay">
        <div class="modal modal-lightbox">
            <button class="btn-icon lightbox-close" id="lightboxClose" type="button">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path d="M18 6 6 18M6 6l12 12" />
                </svg>
